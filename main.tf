...
variable "worker_bundle_url" {
  ...
  type        = string
  default     = "https://github.com/tako0614/yurucommu/releases/download/v2.2.0-rc.3/yurucommu-worker.js"
...
variable "worker_bundle_sha256" {
  ...
  type        = string
  default     = "sha256:67aebddf7f4435353184deeb13855bdebe5a0f39a4393af400b7acc9b7c66257"
