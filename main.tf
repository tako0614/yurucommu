...
variable "worker_bundle_url" {
  ...
  type        = string
  default     = "https://github.com/tako0614/yurucommu/releases/download/v2.2.0-rc.2/yurucommu-worker.js"
...
variable "worker_bundle_sha256" {
  ...
  type        = string
  default     = "sha256:49383b0f78cb03c6297f2e44e778a8d4880ed7217e59c7252a62af003b35a52a"
...
variable "cloudflare_route_zone_id" {
  description = "Optional Cloudflare zone id used to create a Worker route. For the portable adapter this is the host-provided virtual zone id."
  type        = string
  default     = ""
}
