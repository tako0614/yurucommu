...
export type { ApiTransport } from "@takosjp/yurucommu-api";
...
export interface InstanceHealth {
  ...
  retries: number;
  effective_state:
    "active" | "missing" | "provisioning" | "updating" | "failed" | "blocked";
  reasons: string[];
  checked_at: string;
}
...
setYurucommuApiTransportResolver(getApiTransport);
